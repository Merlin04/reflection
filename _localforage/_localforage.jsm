  ...
  */
  (function(f) {
    ...
    return function e(t, n, r) {
      ...
      function getItem2(key3, callback) {
        var self2 = this;
      ...
      function setItem2(key3, value, callback) {
        var self2 = this;
        key3 = normalizeKey(key3);
        var promise = new Promise$1(function(resolve, reject) {
          var dbInfo;
      ...
      function removeItem2(key3, callback) {
        var self2 = this;
        key3 = normalizeKey(key3);
        var promise = new Promise$1(function(resolve, reject) {
          self2.ready().then(function() {
      ...
      function dropInstance2(options, callback) {
